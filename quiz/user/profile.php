...
<div class="container mb-4">
      <h2 class="text-center">Updated detail</h2>
      <div class="row">
        <div class="col-md-6 col-sm-6 offset-md-3 bg-primary text-white">
          <form action="" method="POST" class="p-3">
            ...
            <button class="btn btn-danger mt-2 p-1 font-weight-bold mr-4" name="update">update</button>
