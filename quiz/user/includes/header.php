...
<!--start side-bar-->
    <div class="container-fluid bg-light" style="margin-top: 60px;">
        <button class="btn mb-2" id="menubutton" onclick="openm()">Menu</button>
        <div class="row">
            <nav class="col-sm-3 col-md-2 menu mt-5" id="menu">
                <div class="left-sidebar">
                    <ul class="nav flex-column">
                        <li class="nav-item"> 
                            <a class="nav-link <?php if (page=='showquiz') { echo 'active';} ?>" href="showquiz.php"><i class="fas fa-home mr-2"></i>Home</a></li>
                        <li class="nav-item"> 
                            <a class="nav-link <?php if(page == 'rank.php') { echo 'active'; } ?>" href="rank.php"><i class="fas fa-star mr-2"></i>Ranking</a></li>
                        <li class="nav-item"> 
                            <a class="nav-link <?php if(page == 'profile.php') { echo 'active'; } ?>" href="profile.php"><i class="fas fa-user mr-2"></i>profile</a></li>
                        <li class="nav-item"> 
                            <a class="nav-link <?php if(page == 'history.php') { echo 'active'; } ?>" href="history.php"><i class="fas fa-history mr-2"></i>History</a></li>    
                        <li class="nav-item"> <a class="nav-link" href="../logout.php"><i class="fas fa-sign-out-alt mr-2"></i>Logout</a></li>
                    </ul>
                </div>
            </nav>
<!--        </div>
